...
<ol type="I" markdown="0">
        ...
        <ol>
          ...
          <li><span class="list-number">I.a.2.</span> Bacchus and his followers
            <ol>
              ...
              <li><span class="list-number">I.a.2(2).</span> Silenus, <%= link_to "222-23", "catalogue/208-23.html" %>, <%= link_to "224", "catalogue/224-38.html" %>, <%= link_to "85-86", "catalogue/85-86.html" %>, <%= link_to "333", "catalogue/327-37.html" %>, <%= link_to "626", "catalogue/614-30.html" %>(?)</li>
    ...
    <ol>
      ...
      <li><span class="list-number">III.f.</span> The Theater
        <ol>
          ...
          <li><span class="list-number">III.f.2.</span> Mask, <%= link_to "67", "catalogue/52-69.html" %>, <%= link_to "130", "catalogue/130-42.html" %>, <%= link_to "208", "catalogue/208-23.html" %>(?), <%= link_to "349–52", "catalogue/349-54.html" %>, <%= link_to "405", "catalogue/402-17.html" %>, <%= link_to "447-48", "catalogue/442-48.html" %>, <%= link_to "449", "catalogue/449-50.html" %>, <%= link_to "455", "catalogue/455-58.html" %>, <%= link_to "457", "catalogue/455-58.html" %>, <%= link_to "626a", "catalogue/614-30.html" %>, <%= link_to "626b", "catalogue/614-30.html" %></li>
        </ol>
      </li>
    ...
    <ol>
      <li><span class="list-number">IV.a.</span> Mammals
        <ol>
          ...
          <li><span class="list-number">IV.a.9.</span> Donkey, <%= link_to "91", "catalogue/87-117.html" %>, <%= link_to "95", "catalogue/87-117.html" %>, <%= link_to "188", "catalogue/166-207.html" %>, <%= link_to "215", "catalogue/208-23.html" %>(?), <%= link_to "354", "catalogue/349-54.html" %>, <%= link_to "355", "catalogue/355-56.html" %>(?), <%= link_to "464", "catalogue/463-71.html" %>(?)</li>
  ...
  <li><span class="list-number">VI.</span> Geometric Patterns
    <ol>
      ...
      <li><span class="list-number">VI.c.</span> Row of Ovolos, <%= link_to "33", "catalogue/28-37.html" %>, <%= link_to "39", "catalogue/38-43.html" %>, <%= link_to "44", "catalogue/44-51.html" %>, <%= link_to "83–84", "catalogue/76-84.html" %>, <%= link_to "155–56", "catalogue/147-60.html" %>, <%= link_to "165", "catalogue/161-65.html" %>, <%= link_to "245", "catalogue/243-47.html" %>, <%= link_to "279–80", "catalogue/278-82.html" %>, <%= link_to "314", "catalogue/312-14.html" %>, <%= link_to "315-16", "catalogue/315-16.html" %>, <%= link_to "336", "catalogue/337-37.html" %>, <%= link_to "347", "catalogue/347.html" %>, <%= link_to "348", "catalogue/348.html" %>, <%= link_to "353–54", "catalogue/349-54.html" %>, <%= link_to "361–67", "catalogue/360-74.html" %>, <%= link_to "418–19", "catalogue/418-27.html" %>, <%= link_to "421–27", "catalogue/418-27.html" %>, <%= link_to "460", "catalogue/459-60.html" %>, <%= link_to "468", "catalogue/463-71.html" %>, <%= link_to "485", "catalogue/485-86.html" %>, <%= link_to "518", "catalogue/518.html" %>, <%= link_to "584", "catalogue/582-85.html" %>, <%= link_to "624", "catalogue/614-30.html" %></li>
