...
Purchased in Asia Minor, the hand-modeled cat. 573 is not so much a multinozzled ring-shaped lamp as an assemblage of five whole lamps set in a ring on top of a cylindrical support. Such assemblages of several lamps, making up one large lighting device, date back to the Archaic period (see <a href='../../bibliography/#bailey-bm-i'>Bailey BM I</a>II, addendum to vol. 1, p. 452, Q 462 bis, pl. 150, dated second half of the sixth century B.C. or a little later). The five lamps assembled in cat. 573 are similar to <%= link_to "cats. 8", "catalogue/7-8.html" %>, a close parallel to a lamp from <a href='../../map/#loc_589913'>Lindos</a> dated to the second third of the fifth century B.C. (Kassab Tezgör and Sezer 1995, no. 141).
